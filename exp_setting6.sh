...
#python mcd_job3.py
#jupyter lab
python main.py --eval_method 'cv_neg_smoo' --job_id '1503@j6' --strct_dataset "dataset1" --strct_strategy "subset_mean" --strct_aug_train "True" --strct_aug_eval "True" --n_exp 10 --log_msg "15/03 - cold start evaluation @ negative factor=5, smoothing factor=0.9" --neg_factor "5" --smoo_factor "0.9"  --res_file_name "cold_eval_neg_smoo_1503" --log_file_name "1503_cold_eval_neg_5_smoo_0.9_exp6" --exp_log_dir "1503" --device 'cuda'
